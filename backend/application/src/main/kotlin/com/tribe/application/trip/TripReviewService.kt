...
import com.tribe.domain.itinerary.RecommendedPlaceRepository
import com.tribe.domain.trip.TripReview
import com.tribe.domain.trip.TripReviewRepository
...
class TripReviewService(
    private val tripRepository: com.tribe.domain.trip.TripRepository,
    ...
    private fun createPromptFromTrip(trip: com.tribe.domain.trip.Trip, concept: String?): String {
